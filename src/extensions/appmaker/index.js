...
// Original by LibreKitten. Edited by GaiaWindWave90.
            ...
            blocks: [
                {
                    opcode: 'showAlert',
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.showAlert',
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.showAlertThenWait',
                        // eslint-disable-next-line max-len
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.confirm',
                ...
                },
                {
                    opcode: 'inputDialog',
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.inputDialog',
                ...
                },
                {
                    opcode: 'executeJS',
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.executeJS',
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.executeJSReporter',
                        default: 'execute JavaScript [JS]',
                        description: 'Block that executes JavaScript'
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.showAdvancedButton',
                ...
                {
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.advancedOptionsText',
                ...
                },
                {
                    func: 'trustProject',
                    text: formatMessage({
                        id: 'potentia_appmaker.blocks.trustProject',
